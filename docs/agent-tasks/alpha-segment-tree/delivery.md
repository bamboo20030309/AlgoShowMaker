...
- 驗證時的 HEAD 與未提交修改：1236ab967bb63ae4e9c7d8408d7573736a95cd2b；程式驗證完成後僅更新交付文件
- 驗證日期：2026-09-21
...
- 預期結果：下一幀background與退場segment為相同RGB且background不透明時，value與index background以可觀察的過渡同步塗色；兩者到達目標色後segment才由上往下退場，不露出白色格子。
