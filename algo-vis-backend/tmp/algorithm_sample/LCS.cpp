    ...
    while(getline(cin,S) && getline(cin,T)){
        ...
        if(S=="abcdedcba" && T=="edcbabcde"){
            ...
            av.colored_text({ 
                ...
                {{T.substr(0,7)},"rgba(254, 238, 62, 0.46)"},
                {{" 和 "}},
                {{S.substr(0,3)},"rgba(254, 238, 62, 0.46)"},
                {{" 的 LCS 值"}}
            },0,80);
        ...
        if(S=="abcdedcba" && T=="edcbabcde"){
            ...
            av.colored_text({ 
                ...
                {{S.substr(0,3)},"rgba(254, 238, 62, 0.46)"},
                {{" "}},
                {{T.substr(3,1)},"rgba(50, 191, 87, 0.46)"},
                {{" 的 LCS\n那麼剛好因為新加入的字元是 "}},
                {{"ㄧ樣的"},"rgba(50, 191, 87, 0.46)"},
                {{"\n那麼就可以直接去取剛剛算過的 "}},
                {{T.substr(0,7)},"rgba(254, 238, 62, 0.46)"},
                {{" 和 "}},
                {{S.substr(0,3)},"rgba(254, 238, 62, 0.46)"},
        ...
        if(S=="abcdedcba" && T=="edcbabcde"){
            ...
            av.colored_text({ 
                {{"假設要計算 "}},
                {{"{" + T.substr(0,8) + ":edcba b c d e}"},"rgba(254, 238, 62, 0.46)"},
                {{" "}},
                {{"{" + T.substr(8,1) + "}"},"rgba(254, 62, 62, 0.46)"},
                {{" 和 "}},
                {{S.substr(0,3)},"rgba(254, 238, 62, 0.46)"},
                {{" "}},
                {{T.substr(3,1)},"rgba(254, 62, 62, 0.46)"},
                {{" 的 LCS\n那麼因為新加入的字元是 "}},
                {{"不ㄧ樣的"},"rgba(254, 62, 62, 0.46)"},
                {{"\n那就必須要去找 "}},
                {{T.substr(0,8)},"rgba(254, 238, 62, 0.46)"},
                {{" , "}},
                {{S.substr(0,3)},"rgba(254, 238, 62, 0.46)"},
                {{" "}},
                {{T.substr(3,1)},"rgba(254, 62, 62, 0.46)"},
