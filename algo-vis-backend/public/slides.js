(function () {
    ...
    section.innerHTML = `
      <div class="asm-slide-frame-content">
        <iframe
          ...
          src="${hasScript ? 'algorithm.html?asmEmbed=runtime&v=trace-runtime-37' : 'about:blank'}"
          ${hasScript ? '' : 'hidden'}
        ></iframe>
  ...
  function refreshAlgorithmSlideInPlace(slide) {
    ...
    const runtimeUrl = 'algorithm.html?asmEmbed=runtime&v=trace-runtime-37';
  ...
  function openAlgorithmEditor(slideId) {
    ...
    algorithmEditorFrame.src = 'algorithm.html?asmEmbed=editor&v=trace-runtime-37';
  }
