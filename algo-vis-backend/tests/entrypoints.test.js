...
test('all algorithm surfaces load the same shared modules in dependency order', () => {
  ...
  assert.ok(legacy.includes('home.css?v=auth-center-11'));
  assert.ok(legacy.indexOf('library-layout.js?v=1') < legacy.indexOf('library-organizer.js?v=2'));
  assert.ok(legacy.indexOf('library-organizer.js?v=2') < legacy.indexOf('home.js?v=library-folders-7'));
