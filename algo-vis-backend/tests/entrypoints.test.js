...
test('all algorithm surfaces load the same shared modules in dependency order', () => {
  ...
  assert.ok(legacy.includes('home.css?v=folder-icons-13'));
  assert.ok(legacy.indexOf('library-layout.js?v=1') < legacy.indexOf('library-organizer.js?v=4'));
  assert.ok(legacy.indexOf('library-organizer.js?v=4') < legacy.indexOf('home.js?v=library-folders-7'));
