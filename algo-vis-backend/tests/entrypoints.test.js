...
test('all algorithm surfaces load the same shared modules in dependency order', () => {
  ...
  assert.ok(legacy.includes('home.css?v=card-drag-12'));
  assert.ok(legacy.indexOf('library-layout.js?v=1') < legacy.indexOf('library-organizer.js?v=3'));
  assert.ok(legacy.indexOf('library-organizer.js?v=3') < legacy.indexOf('home.js?v=library-folders-7'));
