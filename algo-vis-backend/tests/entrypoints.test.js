...
test('all algorithm surfaces load the same shared modules in dependency order', () => {
  ...
  assert.ok(html.includes('trace-model.js?v=trace-28'));
  ...
  assert.ok(slides.includes('slides.js?v=parallel-merge-186'));
  ...
  assert.ok(html.includes('trace-arrow-model.js?v=arrow-5'));
